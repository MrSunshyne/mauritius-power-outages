    ...
    <div class="day-timeline relative">
        ...
        >
            ...
            <rect
                ...
                :y="curveTop - 5"
                :width="outageWidth"
                :height="curveHeight + 15"
                fill="url(#outageGradient)"
                stroke="#ef4444"
                stroke-width="1"
                stroke-opacity="0.5"
                rx="2"
            ...
            <g :clip-path="`url(#outageClip-${uniqueId})`">
                ...
                <line
                    v-for="i in outageLineCount"
                    :key="i"
                    :x1="outageStartX + (i - 1) * 8 - 20"
                    :y1="curveTop + curveHeight + 10"
                    :x2="outageStartX + (i - 1) * 8 + 20"
                    :y2="curveTop - 5"
                    stroke="#ef4444"
                    stroke-width="1"
                    stroke-opacity="0.2"
            ...
            <!-- Sunrise icon -->
            <g
                :transform="`translate(${getXForHour(props.sunrise) - 12}, ${axisY - 16})`"
            >
                <defs>
                    <clipPath :id="`sunriseClip-${uniqueId}`">
                        <path
                            d="M24 14.4H14.4l-1.7-1.5a0.9 0.9 0 0 0-1.1 0L10 14.4H0V0h24Z"
                        />
                    </clipPath>
                </defs>
                ...
                <path
                    ...
                    stroke-width="1"
                    d="M6 15.6h4.1l1.9-1.7l1.9 1.7H18"
                    opacity="0.6"
                />
            </g>
            ...
            <!-- Sunset icon -->
            <g
                :transform="`translate(${getXForHour(props.sunset) - 12}, ${axisY - 16})`"
            >
                <defs>
            ...
            <text
                :x="outageStartLabelX"
                :y="outageStartLabelY"
                :text-anchor="outageStartLabelAnchor"
                fill="#ef4444"
                font-weight="300"
                class="timeline-text-emphasis"
            >
            ...
            <text
                :x="outageEndLabelX"
                :y="outageEndLabelY"
                :text-anchor="outageEndLabelAnchor"
                fill="#ef4444"
                font-weight="300"
                class="timeline-text-emphasis"
            >
