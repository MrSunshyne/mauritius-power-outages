...
.wick :after {
  ...
  box-shadow: 0 5px 2px 3px gold, 0 20px 2px 14px gold,
    ...
    0 0px 3px 4px var(--orange), 0 5px 3px 4px gold;
}
...
.flame .top {
  ...
  box-shadow: 0 0px 0px 3px white, 0 -20px 1px 4px white, 0 -25px 2px 3px gold,
    0 -30px 5px 4px var(--orange), 0 0px 150px 10px var(--orange),
    0 -10px 2px 4px white, 0 -5px 3px 3px white;
...
.flame .bottom {
  ...
  box-shadow: 0 6px 10px 12px rgba(60, 76, 125, 0.3),
    ...
    0 5px 7px 12px var(--dark), 0 -3px 10px 12px var(--dark),
