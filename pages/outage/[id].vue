            ...
            <section v-if="selectedOutage" class="mb-8">
                <div class="text-center mb-8">
                    <h1 class="text-2xl sm:text-3xl md:text-4xl font-black text-white leading-tight mb-4">
                        <span v-if="isHistoricalOutage">Oudated </span>Power outage in {{ selectedOutage.locality }}
                    </h1>
                ...
                <div class="bg-white/[0.03] rounded-2xl border border-white/[0.06] overflow-hidden">
                    ...
                    <div class="px-6 py-4 sm:px-8 bg-white/[0.02] border-b border-white/[0.06]">
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 ">
                            ...
                            <div v-else class="flex items-center gap-2 text-base sm:text-md tracking-wide" :class="{
                                'text-sm': true,
                                ...
                                <ClientOnly>
                                    <vue-countdown class="font-mono" v-slot="{ days, hours, minutes, seconds }"
                                        :time="timeDifference">
